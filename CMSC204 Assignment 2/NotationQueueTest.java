...
public class NotationQueueTest {
	...
	public Double x = new Double(30.3);	
	public Double y = new Double(1.1);
	public Double z = new Double(5.5);
	public Double n = new Double(0.0);
	public Double k = new Double(5.8);
	@Before
	...
	public void testDequeueStudent() {
		...
		try {
			...
			assertEquals(y,doubleQ.dequeue());
			doubleQ.dequeue();
			assertTrue("This should cuase an QueueUnderflowExeption", false);
		}
		catch (QueueUnderflowException e){
			assertTrue("This should have caused an QueueUnderflowException", true);
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			doubleQ.enqueue(k);
			assertTrue("This should have caused QueueOverflowException", false);
		}
		catch(QueueOverflowException e) {
			assertTrue("This should have caused an QueueOverflowException", true);
		}
	...
	public void testToStringStudent() throws QueueOverflowException {
		assertEquals("30.31.1",doubleQ.toString());
		doubleQ.enqueue(k);
		assertEquals("30.31.15.8", doubleQ.toString());
	}
