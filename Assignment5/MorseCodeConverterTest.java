...
public class MorseCodeConverterTest {
	...
	public void testConvertToEnglishString() {	
		...
		//my test
		String studentTest = "this is a student test";
		String converter3 = MorseCodeConverter.convertToEnglish("- .... .. ... / .. ... / .- / ... - ..- -.. . -. - / - . ... -");
		assertEquals("this is a student test", converter3);
	}
	...
	public void testConvertToEnglishFile() throws FileNotFoundException {
		...
		//my test
		String studentTest = "hello this is a test file for the student j unit file test";
		getFile("TestFile.txt");
		String converter3 = MorseCodeConverter.convertToEnglish(inputFile);
		assertEquals(studentTest, converter3);
